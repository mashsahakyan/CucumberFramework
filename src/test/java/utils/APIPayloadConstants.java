...
public class APIPayloadConstants {
    public static String createEmployeePayload() {
        String createEmployeePayload = "{\n" +
                "  \"emp_firstname\": \"abcdABCD\",\n" +
                "  \"emp_lastname\": \"ABCDabcd\",\n" +
                "  \"emp_middle_name\": \"aB\",\n" +
                "  \"emp_gender\": \"M\",\n" +
                "  \"emp_birthday\": \"2000-12-01\",\n" +
                "  \"emp_status\": \"Employee\",\n" +
    ...
    public static String createEmployeeBody() {
        ...
        obj.put("emp_firstname", "abcdABCD");
        obj.put("emp_middle_name", "aB");
        obj.put("emp_lastname", "ABCDabcd");
        obj.put("emp_gender", "M");
        obj.put("emp_birthday", "2000-12-01");
